...
public class CapsuleService {
    ...
    @Transactional
    @CacheEvict(value = "my_capsules", key = "#owner.id")
    ...
    @Cacheable(value = "my_capsules", key = "#currentUser.id")
    ...
    @Transactional
    @CacheEvict(value = "my_capsules", key = "#user.id")
    ...
    @Transactional
    @CacheEvict(value = "my_capsules", key = "#me.id")
